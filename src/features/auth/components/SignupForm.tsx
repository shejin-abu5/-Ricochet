...
export function SignupForm() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex w-full max-w-sm flex-col gap-4">
      ...
      {/* The "Already have an account? Log in" link used to live here. It moved
          into the Log in / Sign up toggle at the top of the column — one
          control for switching modes rather than two. */}
    </form>
  )
}
